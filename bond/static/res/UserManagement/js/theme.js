...
(function($) {
	...
	if ( $.isFunction( $.fn[ 'dataTable' ] ) ) {
		...
		$.extend(true, $.fn.dataTable.defaults, {
			oLanguage: {
				sLengthMenu: ' Colunas por página _MENU_',
			...
			fnInitComplete: function( settings, json ) {
				...
				$search
					.attr({
						placeholder: typeof options.searchPlaceholder !== 'undefined' ? options.searchPlaceholder : 'Procurar Coluna...'
					})
...
(function(theme, $) {
	...
	PluginLightbox.defaults = {
		...
		gallery: {
			tPrev: 'Voltar (Left arrow key)', // Alt text on left arrow
			tNext: 'Avançar (Right arrow key)', // Alt text on right arrow
